...
var RemoveScroll = React38.forwardRef(function(props, parentRef) {
  ...
  return React38.createElement(
    ...
    forwardProps ? React38.cloneElement(React38.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef })) : React38.createElement(Container, __assign({}, containerProps, { className, ref: containerRef }), children)
  );
});
