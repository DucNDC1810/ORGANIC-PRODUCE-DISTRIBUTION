...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    ariaLabel: 'View available orders'
  },
  {
    id: 'myorders',
    label: 'My Deliveries',
    icon: PackageCheck,
    description: 'Orders you\'re delivering',
    ariaLabel: 'View your deliveries'
  }
] as const;
...
const ShipperSidebar = ({ 
  ...
  const handleItemClick = useCallback(
    (itemId: string) => {
      setActiveTab(itemId);
      if (window.innerWidth < MOBILE_BREAKPOINT && setSidebarOpen) {
...
export default memo(ShipperSidebar);
